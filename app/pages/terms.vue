<template>
	<section class="container py-12">
		<div class="mb-8">
			<h1 class="text-3xl font-bold">服务协议</h1>
		...
		<div class="prose prose-invert max-w-none">
			<h2>一、协议说明</h2>
			<p>
				本《服务协议》（以下简称“本协议”）是您（“用户”或“您”）与
				{{
					SEO.siteName
				}}（以下简称“我们”）之间关于使用本平台及相关产品/服务所订立的法律文本。
				您在注册、登录、或使用本平台服务之前，应当认真阅读并充分理解本协议。一旦您使用或继续使用，即视为您已阅读并同意本协议的全部内容。
			</p>
			...
			<h2>十一、联系我们</h2>
			<p>
				如对本协议有任何疑问或投诉建议，请通过站点页面的联系方式与我们取得联系：
				<a
