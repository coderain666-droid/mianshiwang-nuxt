...
<template>
	<transition name="fade">
		<button
			v-if="visible"
			@click="scrollTop"
			class="cursor-pointer fixed bottom-6 right-6 z-50 inline-flex items-center gap-2 px-3 py-2 rounded-full shadow-md bg-white border border-gray-200 text-sm text-neutral-700 hover:shadow-lg hover:bg-neutral-50"
			aria-label="返回顶部"
		>
