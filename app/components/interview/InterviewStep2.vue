<template>
	<div class="max-w-7xl mx-auto">
		...
		<div class="grid lg:grid-cols-3 gap-6">
			<!-- 左侧：对话区域（占2列） -->
			<div class="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col" style="height: calc(100vh - 250px)">
				<!-- 对话消息列表 -->
				...
				<div class="border-t border-gray-200 p-4">
					...
					<div class="flex items-center justify-between mt-2 text-xs text-neutral-500">
						...
						<div class="flex items-center gap-4">
							...
							<UButton
								v-else-if="interviewStatus === 'idle' || interviewStatus === 'starting'"
								color="primary"
								size="sm"
			...
			<!-- 右侧：3D 数字人（占1列） -->
			<div class="lg:col-span-1 bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col" style="height: calc(100vh - 250px)">
				...
				<!-- 3D 数字人容器 -->
				<div class="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 relative overflow-hidden">
